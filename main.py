...
class FacturaExtractorApp:
    ...
    def modo_coordenadas(self):
        ...
        print("\n=== MODO: EXTRACCIÓN DE COORDENADAS ===")
        print("Este modo te permite definir campos en facturas usando OpenCV")
        print()

        try:
            from coordinate_extractor import main as coordinate_main
            coordinate_main()
        except Exception as e:
            print(f"Error ejecutando extractor de coordenadas: {e}")
